  ...
  _createClass(AdminHome, [{
    ...
    value: function getUser() {
      ...
      fetch("/api/team/".concat(userId)).then(function (res) {
        ...
        _this4.setState({
          valueSkillBind: user.skills.map(function (suggestion) {
            return {
              value: suggestion._id,
              label: suggestion.name
            };
        ...
        console.log(_this4.state.valueSkillBind);
...
//# sourceMappingURL=4.824e8511bd10e331dcdd.hot-update.js.map