...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return GA_TRACKING_ID; });
...
var GA_TRACKING_ID = '<UA-115010352-1>'; // https://developers.google.com/analytics/devguides/collection/gtagjs/pages
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("html", {
        ...
        async: true,
        src: "https://www.googletagmanager.com/gtag/js?id=".concat(__WEBPACK_IMPORTED_MODULE_3__lib_gtag__["a" /* GA_TRACKING_ID */]),
        __source: {
          fileName: _jsxFileName,
          lineNumber: 19
        }
        ...
        dangerouslySetInnerHTML: {
          __html: "\n            window.dataLayer = window.dataLayer || [];\n            function gtag(){dataLayer.push(arguments);}\n            gtag('js', new Date());\n\n            gtag('config', '".concat(__WEBPACK_IMPORTED_MODULE_3__lib_gtag__["a" /* GA_TRACKING_ID */], "');\n          ")
        },
        __source: {
          fileName: _jsxFileName,
          lineNumber: 23
