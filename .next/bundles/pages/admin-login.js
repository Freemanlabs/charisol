...
var _jsxFileName = "C:\\Users\\user\\challaris-tech-website\\pages\\admin-login.js";
  ...
  _createClass(AdminLogin, [{
    ...
    value: function saveUserData(userReponse) {
      ...
      __WEBPACK_IMPORTED_MODULE_0_isomorphic_unfetch___default()("/api/update-create/".concat(user.email), {
        ...
        __WEBPACK_IMPORTED_MODULE_2_next_router___default.a.push("/admin-profile?_id=".concat(data.user._id), "/dashboard/profile/".concat(data.user._id));
      });
    }
  }, {
    key: "render",
...
(function () {
  ...
  reactHotLoader.register(initialState, "initialState", "C:\\Users\\user\\challaris-tech-website\\pages\\admin-login.js");
  reactHotLoader.register(AdminLogin, "AdminLogin", "C:\\Users\\user\\challaris-tech-website\\pages\\admin-login.js");
  reactHotLoader.register(_default, "default", "C:\\Users\\user\\challaris-tech-website\\pages\\admin-login.js");
  leaveModule(module);
})();
