...
/***/ "./pages/admin-contact-message.js":
...
var _jsxFileName = "/Users/macbook/workspace/charisol/challaris-tech-website/pages/admin-contact-message.js";
...
var AdminContactMessage =
/*#__PURE__*/
function (_React$Component) {
  _inherits(AdminContactMessage, _React$Component);

  function AdminContactMessage(props) {
    var _this;

    _classCallCheck(this, AdminContactMessage);

    _this = _possibleConstructorReturn(this, (AdminContactMessage.__proto__ || Object.getPrototypeOf(AdminContactMessage)).call(this, props));
  ...
  _createClass(AdminContactMessage, [{
    key: "getUsers",
    value: function getUsers() {
      var _this2 = this;

      fetch("/api/get-contacts").then(function (res) {
        return res.json();
      }).then(function (data) {
        console.log(data);
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7__components_admin_Dashboard__["a" /* default */], {
      ...
      }, this.state.contacts.map(function (n, i) {
        ...
        }, n.message.substring(0, 14) + '...'), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_20__material_ui_core_TableCell___default.a, {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 187
          }
...
var _default = Object(__WEBPACK_IMPORTED_MODULE_2__material_ui_core_styles__["withStyles"])(styles)(AdminContactMessage);
...
(function () {
  ...
  reactHotLoader.register(initialState, "initialState", "/Users/macbook/workspace/charisol/challaris-tech-website/pages/admin-contact-message.js");
  reactHotLoader.register(styles, "styles", "/Users/macbook/workspace/charisol/challaris-tech-website/pages/admin-contact-message.js");
  reactHotLoader.register(AdminContactMessage, "AdminContactMessage", "/Users/macbook/workspace/charisol/challaris-tech-website/pages/admin-contact-message.js");
  reactHotLoader.register(_default, "default", "/Users/macbook/workspace/charisol/challaris-tech-website/pages/admin-contact-message.js");
  leaveModule(module);
})();
...
;
    ...
    })(typeof __webpack_exports__ !== 'undefined' ? __webpack_exports__.default : (module.exports.default || module.exports), "/admin-contact-message")
...
//# sourceMappingURL=4.85ce633fabcf072e2808.hot-update.js.map