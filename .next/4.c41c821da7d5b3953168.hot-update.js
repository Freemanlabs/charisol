  ...
  _createClass(AdminHome, [{
    ...
    value: function getUser() {
      ...
      fetch("/api/team/".concat(userId)).then(function (res) {
        ...
        valueSkillBind = (_readOnlyError("valueSkillBind"), user.skills.map(function (suggestion) {
          return {
            value: suggestion._id,
            label: suggestion.name
          };
...
//# sourceMappingURL=4.c41c821da7d5b3953168.hot-update.js.map