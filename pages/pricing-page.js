                ...
                <div className="pricing-wrapper columns">
                    <div className="row pricing-wrapper-container">
                        <div className="columns">
                            ...
                            <div className="icon-container" style="background-image: url('assets/img/icon_hour.svg')"></div>
                        ...
                        <div className="columns">
                            <div className="text-center tile pricing-tile">
                            <div className="icon-container" style="background-image: url('assets/img/icon_week.svg')"></div>
                            <div className="text-wrapper">
                        ...
                        <div className="columns">
                            ...
                            <div className="icon-container" style="background-image: url('assets/img/icon_month.svg')"></div>
                            <div className="text-wrapper">
                        ...
                        <div className="columns">
                            <div className="text-center tile pricing-tile">
                            <div className="icon-container" style="background-image: url('assets/img/icon_demand.svg')"></div>
                            <div className="text-wrapper">
                                <h5>On Demand</h5>
